...
class ArendatorForm(ModelForm):
    ...
    class Meta(object):
        ...
        widgets = {
            ...
            'number_of_storeys': SelectMultiple(attrs={'class': 'tarea-multiple', 'multiple': 'multiple'}),
            'entrance': SelectMultiple(attrs={'class': 'tarea-multiple', 'multiple': 'multiple'}),
            'location': SelectMultiple(attrs={'class': 'tarea-multiple', 'multiple': 'multiple'}),
            'type_stage': SelectMultiple(attrs={'class': 'tarea-multiple', 'multiple': 'multiple'}),
